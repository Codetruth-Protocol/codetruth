...
- [SDKs](./integration/sdks.md)
  - [TypeScript/Node.js](./integration/sdk-typescript.md)
  - [Python](./integration/sdk-python.md)

# Protocol Specification

- [Architecture](./spec/architecture.md)
- [Protocol Messages](./spec/messages.md)
- [Explanation Graph Schema](./spec/explanation-graph.md)
- [Policy Definition Language](./spec/pdl.md)
...
- [Architecture Review](./dev/ARCHITECTURE_REVIEW.md)
- [Extended Drift Categories](./dev/EXTENDED_DRIFT_CATEGORIES.md)
